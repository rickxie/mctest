...
(function (g) {
        ...
        if (o && o.charAt(0) === '.') if (v) {
            ...
            for (H = 0; H < o.length; H += 1) {
                ...
                if (D === '.') {
                    o.splice(H, 1);
                    H -= 1
                } else if (D === '..') if (H === 1 && (o[2] === '..' || o[0] === '..')) break;
                else if (H > 0) {
                    o.splice(H - 1, 2);
                    H -= 2
                }
    ...
    m = function (o, v, D, p) {
        ...
        if (F === 'undefined' || F === 'function') {
            ...
            if (o) if (y && y.exports !== g && y.exports !== t[o]) t[o] = y.exports;
            else if (v !== g || !E) t[o] = v
        } else if (o) t[o] = D
    };
...
(function () {
    var g = {
        ...
        indexOf: function (a, b) {
            ...
            else if (c.isObject(a)) for (var e in a) if (a.hasOwnProperty(e) &&
                a[e] === b) return e
        },
        every: function (a, b) {
        ...
        each: function (a, b) {
            ...
            else if (c.isObject(a)) for (var e in a) if (a.hasOwnProperty(e)) if (b.call(a[e], a[e], e, a) === false) break
        },
        map: function (a, b) {
            var c = g.type;
            if (a.length) [].map.call(a, b);
            else if (c.isObject(a)) for (var e in a) if (a.hasOwnProperty(e)) a[e] = b.call(a[e], a[e], e, a)
        },
        filter: function (a, b) {
            var c = g.type;
...
J.$package(function (g) {
    ...
    if (window.getComputedStyle) {
        ...
        a = (Array.prototype.slice.call(a).join('').match(/-(moz|webkit|ms)-/) || a.OLink === '' && ['',
            'o']) [1];
    ...
    var a = document,
        ...
        r = {
            $: function (k, d) {
                var t;
                d = d || a;
                if (e.test(k)) return (t = this.id(k.replace('#', ''))) ? [
                    t
                ] : [
                ];
    ...
    var a = window,
        ...
        j = {
            ...
            transitionend: function () {
                ...
                else if ('onwebkittransitionend' in a) return 'webkitTransitionEnd';
...
J.$package(function (g) {
    var a = g.type,
        ...
        f = function (q, w, C) {
            if (q.removeEventListener) q.removeEventListener(w, C, false);
            else {
                w = w.toLowerCase();
        ...
        n = {
            on: function (q, w, C) {
                var h;
                if (a.isArray(q)) for (h = q.length; h--; ) n.on(q[h], w, C);
                else if (a.isString(w) && w.indexOf(' ') > 0) {
                    w = w.split(' ');
                    for (h = w.length; h--; ) n.on(q, w[h], C)
                } else if (a.isArray(C)) for (h = C.length; h--; ) n.on(q, w, C[h]);
                else if (a.isObject(w)) for (h in w) n.on(q, h, w[h]);
                else if (h = e(q, w)) {
                    w = h;
                    j(q, w, C)
            ...
            off: function (q, w, C) {
                ...
                } else if (a.isArray(C)) for (h = C.length; h--; ) n.off(q, w, C[h]);
                else if (a.isObject(w)) for (h in w) n.off(q, h, w[h]);
            ...
            fire: function (q, w) {
                ...
                if (h = e(q, w)) {
                    ...
                    h = q.events[w];
                    for (var o = 0, v = h.length; o < v; o++) h[o].apply(window, C)
                }
            },
            getActionTarget: function (q, w, C, h) {
                ...
                for (; q && q !== h && (w ? o-- > 0 : true); ) if (q.getAttribute(C)) return q;
                else q = q.parentNode;
                return null
            },
    ...
    var a = g.dom,
        ...
        j = g.Class({
            init: function (f) {
                ...
                this.setDuration(f.duration || 1000);
            ...
            _transit: function (f) {
                ...
                var m = 'all ' + this.duration / 1000 + 's ' + this.runType + ' ' + this.delay / 1000 + 's';
...
J.$package(function (g) {
    ...
    g.cookie = {
        set: function (b, c, e, j, f) {
            if (f) {
                var n = new Date;
                n.setTime((new Date).getTime() + 3600000 * f)
            }
...
J.$package(function (g) {
    ...
    g.http = a
}); typeof define === 'function' && define('jm', [
], function () {
    return J
}); (function (g, a) {
    function b(u) {
        ...
        _scrollbarPos: function (u, s) {
            ...
            if (this[u + 'Scrollbar']) {
                ...
                if (A < 0) {
                    ...
                    A = 0
                } else if (A > this[u + 'ScrollbarMaxScroll']) if (this.options.fixedScrollbar) A = this[u + 'ScrollbarMaxScroll'];
                else {
        ...
        _start: function (u) {
            ...
            if (this.enabled) {
                ...
                if (this.options.zoom && C && u.touches.length > 1) {
                    ...
                    this.options.onZoomStart && this.options.onZoomStart.call(this, u)
                }
    ...
    e = null;
    g.iScroll = O;
    typeof define === 'function' && define('iscroll', [
    ], function () {
        return O
    })
}) (this, document); function pgvGetCookieByName(g) {
...
function trimUin(g) {
    var a = pvNone;
    return g != pvNone && (g = g.replace(RegExp('[^0-9]', 'gm'), ''), a = g.replace(RegExp('^0+', 'gm'), ''), a == '' && (a = pvNone)),
        a
}
function pgvGetNewRand() {
    ...
    return n.length > 13 && pgvRealSetCookie('o_cookie='),
        b != pvNone ? (pgvRealSetCookie('o_cookie=' + b), '&nrnd=' +
...
function tracert() {
    if (pgvIsPgvDomain()) {
        ...
        g = 'pj=1990&dm=' + Tcss.dm + '&url=' + Tcss.url + '&arg=' + Tcss.arg + '&rdm=' + Tcss.rdm + '&rurl=' + Tcss.rurl + '&rarg=' + Tcss.rarg + '&icache=' + Tcss.pgUserType + '&uv=&nu=&ol=&loc=' + g + '&column=' + Tcss.column + '&subject=' + Tcss.subject + pgvGetNewRand() + '&rnd=' + Math.round(Math.random() * 100000);
...
function staybounce() {
    ...
    var g = dt.getTime(),
        a = new Image(1, 1);
    a.src = 'http://trace.qq.com:80/collect?pj=8887&url=' + escape(location.href) + '&t=' + parseInt((g - pvStartTime) / 1000) + '&v=' + pvClickCount + '&u=' + trimUin(pgvGetCookieByName('o_cookie'));
    delete a
}
var pvNone = '-', pvStartTime = 0, sendUrl, pvClickCount = 0, pvSetupHot = 1, pvCurDomain = '', pvCurUrl = '', pvRefDomain = '', pvRefUrl = ''; if (typeof pvRepeatCount == 'undefined') var pvRepeatCount = 1; (function () {
    function g(h) {
        this.url = [
        ];
        this.init(h)
    ...
    g.prototype = {
        ...
        run: function () {
            ...
            e.hot && (document.attachEvent ? document.attachEvent('onclick', function (p) {
                pgvWatchClick(p)
        ...
        coverCookie: function () {
            if (e.crossDomain && e.crossDomain == 'on') {
                var h = this.getParameter('tcss_uid', a.URL),
                    ...
                    D = this.getParameter('tcss_last', a.URL);
        ...
        getDomainInfo: function (h) {
            ...
            e.virtualDomain && (d.push('ad=' + o), o = e.virtualDomain),
                this.getCurrentUrl(),
                Tcss.dm = o,
            q && pgvGetDomainInfo(),
                j = Tcss.dm,
            f || (f = this.getCookieSetDomain(b.hostname.toLowerCase()), q && (Tcss.domainToSet = f)),
            h && (Tcss.dm += '.hot'),
        ...
        getCookieSetDomain: function (h) {
            for (var o, v, D, p = [
            ], y = 0, F = 0; F < h.length; F++) h.charAt(F) == '.' && (p[y] = F, y++);
            return o = p.length,
                v = h.indexOf('.cn'),
            v > - 1 && o--,
        ...
        watchClick: function (h) {
            try {
                ...
                if (o) {
                    ...
                    p.url.push('&hotx=' + y.x);
                    p.url.push('&hoty=' + y.y);
                    p.url.push('&rand=' + Math.round(Math.random() * 100000));
        ...
        getElementPos: function (h) {
            ...
            if (document.getBoxObjectFor) {
                ...
                D = [
                    p.x - (h.style.borderLeftWidth ? Math.floor(h.style.borderLeftWidth)  : 0),
                    p.y - (h.style.borderTopWidth ?
        ...
        sendClick: function () {
            e.hottag && (this.url.push(this.getDomainInfo(true)), this.url.push('&hottag=' + escape(e.hottag)), this.url.push('&hotx=9999&hoty=9999'), this.url.push('&rand=' + Math.round(Math.random() * 100000)), this.url.unshift('http://pinghot.' + this.getCookieSetDomain(j) + '/pingd?'), this.sendInfo(this.url.join('')))
        },
        pgvGetArgs: function () {
            this.getDomainInfo();
            var h = [
    ...
    var C = {
        ...
        setCookie: function (h, o, v) {
            ...
            if (p == '-' && !v) {
                ...
                p += Math.round(Math.abs(Math.random() - 1) * 2147483647) * v % 10000000000
            } else p = v ? v : p;
            if (o) switch (h) {
                case 'ts_uid':
                    this.saveCookie(h +
        ...
        getExpires: function (h) {
            var o = new Date;
            return o.setTime(o.getTime() + h * 60 * 1000),
            'expires=' + o.toGMTString()
        },
        save: function () {
            if (e.sessionSpan) {
                var h = new Date;
                h.setTime(h.getTime() + e.sessionSpan * 60 * 1000)
            }
            for (var o = '', v = this.sck.length, D = 0; D < v; D++) o += this.sck[D] + '=' + this.sco[this.sck[D]] + '&';
...
(function (g) {
    ...
    window.onerror = function (b, c, e) {
        b = 'http://badjs.qq.com/cgi-bin/js_report?' + ['bid=130&',
                'msg=' + encodeURIComponent([b,
                    c,
                    e,
                    navigator.userAgent].join('|_|'))].join('&');
        a = new Image;
        a.src = b;
        new Image;
    ...
    J.$package('mq', function () {
        ...
        this.saveSetting = function (a) {
            for (var b = [
                ...
                'enableHttps',
                'enableCtrlEnter'
            ], c = 0, e; e = b[c]; c++) if (e in a) this.setting[e] = localStorage[e] = a[e]
        }
    })
});
define('tmpl', {
...
define('tmpl!../tmpl/tmpl_main_top.html', [
], function () {
    return function (g) {
        var a,
            b = '';
        ...
        this.Tab = new g.Class({
            ...
            get: function (e) {
                ...
                if (c.isNumber(e)) {
                    ...
                    j = this._map[e];
                    if (!j) return null;
                    for (var f = 0, n; n = this._arr[f]; f++) if (n.id === e) return {
                        item: j,
                        index: f
                    };
                    return null
...
define('../lib/mui/js/mui.textarea', [
    'jm'
], function () {
    JM.$package('MUI', function (g) {
        var a = g.dom,
        ...
        this.AutoGrowTextarea = g.Class({
            ...
            reset: function () {
                a.setStyle(this.hiddenTextarea, 'height', this.initHeight + 'px');
...
define('../lib/mui/js/mui.lazyload', [
    'jm'
], function () {
    JM.$package('MUI', function (g) {
        var a = g.dom,
...
define('../lib/mui/js/mui.imagechange', [
    'jm'
], function () {
    JM.$package('MUI', function (g) {
        var a = g.dom,
        ...
        this.ImageChange = g.Class({
            init: function (c) {
                ...
                this.autoChangeTime = c.autoChangeTime || 3000;
                this._initBtns();
                this.bindHandlers();
            ...
            slideTo: function (j) {
                ...
                setTimeout(function () {
                    if (e) f.contentWrap.style['-webkit-transition'] =
                        'all ' + f.slideTime / 1000 + 's ' + f.runType;
...
define('../lib/mui/js/mui.swipechange', [
    ...
    JM.$package('MUI', function (g) {
        var a = g.dom,
            ...
            e,
            j = (c = g.platform.touchDevice) ? 'touchstart' : 'mousedown',
...
define('mq.view.transitionmanager', [
    ...
    J.$package('mq.view.transitionManager', function (g) {
        ...
        j || (j = '');
        var f = function (m, r) {
            for (var k = 0, d = m.length; k < d; k++) if (m[k].id === r) return {
                item: m[k],
                index: k
            };
            return null
...
define('tmpl!../tmpl/tmpl_title_panel.html', [
], function () {
    return function (g) {
        var a,
            b = '';
...
define('tmpl!../tmpl/tmpl_main_menu.html', [
], function () {
    return function (g) {
        var a,
            b = '';
...
define('mq.view.TitlePanel', [
    ...
    J.$package('mq.view', function (b) {
        ...
        this.TitlePanel = b.Class({
            ...
            show: function () {
                e.setStyle(this.container, 'display', 'block')
            },
            hide: function () {
    ...
    J.$package('mq.report', function (g) {
        var a = JM.type,
            ...
            f = function (m) {
                for (var r in c) {
                    for (var k = c[r], d = {
                    }, t = r.split('-'), B = false, z = 0; z < t.length; z++) d['flag' + (z + 1)] = t[z];
        ...
        (function () {
            window.onerror = function (m, r, k) {
                m = 'http://badjs.qq.com/cgi-bin/js_report?' + ['bid=254&',
...
define('mq.rpcservice', [
    ...
    J.$package('alloy', function () {
        ...
        if ('postMessage' in window) if (window.addEventListener) window.addEventListener('message', C, false);
        ...
        this.require = function (E) {
            var G = E.data || E.param || {
                ...
                s = E.https,
                A;
            if (/^(http|https):\/\/d.web2.qq.com/.test(O)) if (A = g.cookie.get('uin')) {
                A = A.replace('o', '');
...
define('mq.model.memberlist', [
    ...
    J.$package('mq.model.buddylist', function (g) {
        var a = JM.event,
            ...
            C,
            h,
            o = mq.STATIC_CGI_URL + 'api/get_user_friends2',
            ...
            L = {
                onGetFriendsListSuccess: function (x) {
                    ...
                    x = x.marknames || [];
                    for (var V = {
                    }, Y = false, S = 0; S < I.length; S++) if (I[S].index == 0) Y = true;
        ...
        this.getAvatar = function (x, I) {
            ...
            return 'http://face' + x % 10 + '.web.qq.com/cgi/svr/face/getface?cache=1&type=' +
                I + '&f=40&uin=' + x + '&t=' + Math.floor(new Date / 1000) + '&vfwebqq=' + mq.vfwebqq
        };
        ...
        var g = JM.event,
            ...
            c = {
                onRecentListChange: function (e) {
                    for (var j = b.model, f = j.getSelfUin(), n = [
                    ], m, r = 0, k; k = e[r]; r++) if (k.uin != f) {
                ...
                onReceiveMessage: function (e) {
                    ...
                    b.sessionView.onReceiveMessage(e, j)
                },
...
define('mq.model.chat', [
    ...
    J.$package('mq.model.chat', function (g) {
                    ...
                    case 'message':
                        ...
                        if (h) {
                            D =
                            {
                                ...
                                sender: h,
                                sender_uin: v,
                                time: o.time ? o.time * 1000 : + new Date
                            };
                            n.addMessage(v, D)
                        }
                        break;
        ...
        this.receiveMessage = function (h) {
            ...
            if (v) {
                D = {
                    ...
                    to_uin: D,
                    to_user: p,
                    time: h.time ? h.time * 1000 : + new Date
                };
        ...
        this.nextOfflineFile = function (h) {
            var o = [
                    ['nextofffile',
                        '您取消了离线文件"' + h.name + '"的接收，我们将在您下次登录后进行提醒。']
                ],
                v = {
                    type: 'nextofffile',
                    name: h.name,
...
define('tmpl!../tmpl/tmpl_chat_footer.html', [
], function () {
    return function (g) {
        var a,
            b = '';
...
define('tmpl!../tmpl/tmpl_chat_list.html', [
], function () {
    return function (g) {
        var a,
            b = '';
        with (g || {
            ...
            for (var c; c = list[g]; g++) {
                ...
                if (c.htmlContent) {
                    ...
                    b += '\r\n    <p class="chat_content ">' + ((a = translate(c.htmlContent)) == null ? '' : a) + '</p>\r\n</div>\r\n\r\n'
                }
            }
            b += '\r\n'
        }
...
define('mq.view.chat', [
    ...
    J.$package('mq.view.chat', function (b) {
        ...
        this.updateBuddyInfo = function (p) {
            var y,
                F = this.panel.body.querySelectorAll('div[_sender_uin="' +
                    p.account + '"]');
...
define('mq.presenter.chat', [
    ...
    J.$package('mq.presenter.chat', function (g) {
        ...
        var h = function () {
            ...
            a.on(mq.view.chat, 'close', C.onClose);
        ...
        this.translateMessage = function (p) {
            for (var y =
                p.content, F = p.from_uin, H = !F || F == mq.model.buddylist.getSelfUin(), M = [
            ], P = 0, E; E = y[P]; P++) if (g.type.isArray(E)) switch (E[0]) {
                case 'font':
                    break;
                case 'face':
                    E = z.indexOf(E[1]);
        ...
        var o = function (p) {
            ...
            D = function (p) {
                var y = p.attach.from_uin + '_' + p.attach.msg_id,
                    F = g.format.date(new Date(p.attach.expire_time * 1000), 'YYYY-MM-DD'),
...
define('tmpl!../tmpl/tmpl_search_body.html', [
], function () {
    return function (g) {
        var a,
            b = '';
...
define('tmpl!../tmpl/tmpl_member_list.html', [
], function () {
    return function (g) {
        var a,
            b = '';
            ...
            if (type === 'category') {
                ...
                for (g = 0; c = list[g]; g++) {
                    ...
                    if (typeof dataType != 'undefined' && dataType === 'recent') b += '\r\n    <p id="recent-item-' + ((a = c.type) == null ? '' : a) + '-' + ((a = c.account) == null ? '' : a) + '-msg" class="member_msg text_ellipsis">' + ((a = c.recentMessage || '') == null ? '' : a) + '</p>\t\r\n    ';
                        ...
                        if (c.stateName) b += '\r\n    <span class="member_state">' + ((a = c.stateName) == null ? '' : a) + '</span>\r\n    ';
                        b += '\r\n    ';
...
define('mq.presenter.profile', [
    ...
    J.$package('mq.presenter.profile', function () {
        ...
        this.init = function () {
            ...
            a.on(g.model, 'userSignatureChange', c.onUserSignatureChange)
        };
        var c = {
...
define('tmpl!../tmpl/tmpl_profile_body.html', [
], function () {
    return function (g) {
        var a,
            b = '';
        with (g || {
            ...
            if (profile.type === 'friend') {
                ...
                if (profile.birthday) {
                    g = profile.birthday;
                    b += '\r\n    <div class="row ">\r\n        <span class="label">' + ((a = $M('birthday')) == null ? '' : a) + '</span>' + ((a = g.year + '/' + g.month + '/' + g.day) == null ? '' : a) + '\r\n    </div>\r\n    '
                }
                b += '\r\n</div>\r\n<div class="group">\r\n    ';
                ...
                b += '\r\n    ';
                if (profile.mobile) b += '\r\n    <div class="row ">\r\n        <span class="label">' + ((a = $M('mobile')) == null ? '' : a) + '</span>' + ((a = encode(profile.mobile + '')) == null ? '' : a) + '\r\n    </div>\r\n    ';
                b += '\r\n    ';
            ...
            b += '\r\n';
            if (profile.type === 'discuss') b += '\r\n<div class="group clickable">\r\n    <div class="row clearfix" cmd="viewDiscussMember">\r\n        <span class="label">' + ((a = $M('discuss_member')) == null ? '' : a) + '</span><span class="more_icon"></span><span class="text_right">' + ((a = profile.members.length + $M('buddy_unit')) == null ? '' : a) + '</span>\r\n    </div>\r\n</div>\r\n';
            b += '\r\n'
        }
        return b
    }
...
define('tmpl!../tmpl/tmpl_record_footer.html', [
], function () {
    return function (g) {
        var a = '';
        with (g || {
        ...
        this.renderRecord = function (k) {
            ...
            if (!q || q.length == 0) w.innerHTML += '<p class=\'no_record\'>' + f('noRecord') + '</p>';
                ...
                for (var C = q.length; d < C; d++) {
                    z = q[d];
                    var h = a.format.date(new Date(z.time * 1000), 'YYYY-MM-DD hh:mm:ss');
                    if (z.cmd == 16) {
                        z = z.msg[0];
...
}); define('tmpl!../tmpl/tmpl_session_body.html', [
], function () {
    return function (g) {
        var a = '';
        with (g || {
...
define('tmpl!../tmpl/tmpl_contact_body.html', [
], function () {
    return function (g) {
        var a,
            b = '';
...
define('mq.view.contact', [
    ...
    J.$package('mq.view.contact', function (b) {
        ...
        this.init = function () {
            ...
            for (var k = [
            ], d = j.id('memberTab').children, t, B = 0, z, q, w; z = d[B]; B++) {
                            ...
                            if (this.inVisibleArea(k[t])) {
                                ...
                                for (q = d.length; z < q; ++z) {
                                    ...
                                    if (this.inVisibleArea(friendEle)) {
                                        e.fire(c, 'memberInVisibleArea', friendEle.getAttribute('_uin'), 'friend');
                                        w = true
                                    } else if (w) {
                                        C = true;
                                        break
...
define('tmpl!../tmpl/tmpl_setting_body.html', [
], function () {
    return function (g) {
        var a,
            b = '';
        ...
        this.Select = g.Class({
            ...
            bindHandlers: function () {
                ...
                b.on(this.elem, 'click', function (m) {
                    ...
                    c.select_list.style.display != 'block' ? a.setStyle(c.select_list, 'display', 'block')  : a.setStyle(c.select_list, 'display', 'none');
                    if (a.closest(m, 'ul')) {
                        e = a.closest(m, 'li');
...
define('tmpl!../tmpl/tmpl_plugin_body.html', [
], function () {
    return function (g) {
        var a,
            b = '';
            ...
            case b.MOBILE:
                var f =
                    g.Class({
                        ...
                        off: function (d, t) {
                            this._el.removeEventListener(d, t, false)
                        }
                    });
                if (j = b.NATIVE) {
                    g.Audio = f;
                ...
                g.Audio = g.Class({
                    ...
                    getPosition: function () {
                        ...
                        return d.audioGetPosition &&
                            d.audioGetPosition(this._seq) / 1000 || 0
                    },
                    setPosition: function (d) {
                        isNaN(d) || c().audioSetPosition(this._seq, Math.max(0, d) * 1000)
                    },
                    getBuffered: function () {
                        var d = c();
                        return d.audioGetBuffered && d.audioGetBuffered(this._seq) / 1000 || 0
                    },
                    getDuration: function () {
                        var d = c();
                        return d.audioGetDuration && d.audioGetDuration(this._seq) / 1000 || 0
                    },
                    free: function () {
                        this._paused = true;
                        var d = c();
                ...
                g.Audio = g.Class({
                    ...
                    on: function (d, t) {
                        ...
                        switch (d) {
                            ...
                            case 'canplay':
                                if (!this._hasOpenStateChange()) {
                                    this._onOpenStateChange =
                                        function (z) {
                                            if ((B._el.currentMedia || 0).sourceURL) if (z === 21) B._fire('loadstart');
                                            else if (z === 13) {
                                                B._fire('loadeddata');
                                                B._fire('canplay')
                                            }
                            ...
                            case 'durationchange':
                                this._startPoll()
                        }(this._handler[d] || (this._handler[d] = [
                        ])).push(t)
                    },
                    off: function (d, t) {
                        if (this._handler) {
...
define('tmpl!../tmpl/tmpl_notify_setting.html', [
], function () {
    return function (g) {
        var a,
            b = '';
...
define('tmpl!../tmpl/tmpl_main_footer.html', [
], function () {
    return function (g) {
        var a,
            b = '';
...
define('mq.view.main', [
    ...
    J.$package('mq.view.main', function (a) {
        var b = this,
            ...
            e,
            j,
            f = window.localStorage.localBgImage,
            n = JM.event,
            m = JM.dom,
            r = mq.i18n.message;
        this.init = function () {
            ...
            if (a.platform.touchDevice) z = m.id('container');
                ...
                z = window.innerWidth > 1000 ? m.id('main_container')  : m.id('container');
                n.on(window, 'resize', function () {
                    var y = m.className('main-panel', document.body) [0];
                    z =
                        window.innerWidth < 1000 ? m.id('container')  : m.id('main_container');
                    z.appendChild(y)
                })
            }
            var q = {
    ...
    (function (g, a) {
        ...
        var c = {
            ...
            m = f({
                ...
                _isFree: function (k, d) {
                    if (k && 'ts' in k && + new Date - k.ts < this.timeout * 1000) return false;
                    else if (k && 'ts' in k) {
                        if (!k.finish) {
                            this._onError();
                            this._setFree(d);
        ...
        var r = f({
            __init__: function (k) {
                ...
                for (var d = [
                ], t = 0; t < k.flags.length; t++) d.push('flag' + (1 + t) + '=' + k.flags[t]);
        ...
        var b = JM.event,
            ...
            z = {
                ...
                onSelfOffline: function (q) {
                    mq.bubble(q.message, q.action == 'relogin' ? 0 : 5000)
                }
            };
        this.bindHandlers =
            function () {
